...
const en = {
    ...
    dictionary: {
        ...
        profile_picture_invalid_file: "Invalid file type. Please select an image file (PNG, JPG, or JPEG).",
        profile_picture_load_failed: "Failed to load image. The file may be corrupted or not a valid image.",
        profile_picture_remove_failed: "Failed to remove profile picture",
        profile_picture_update_failed: "Failed to update profile picture",
        profile_picture_too_large: "File is too large. Maximum size is 10MB.",
        favorites: "Favorites",
        feedback: "Feedback",
